...
<head>
    ...
    <script src="./Leaflet/consultaMarc.js"></script>
    <script src="./Leaflet/consultaShap.js"></script>
    <script src="./Leaflet/file.js"></script>
    <script src="./Leaflet/leaflet.shpfile.js"></script>
    <script src="./Leaflet/shp.js"></script>
    <script src="./Leaflet/FileSaver.min.js"></script>
